...
1. **Pengisian Identitas**: 
   - Customer mengisi **NIK (16 Digit)**, **Nama Lengkap**, **Nomor HP (WhatsApp Aktif)**, **Alamat Rumah**, serta *Email* & *Catatan Khusus* (opsional).
...
3. **Pemilihan Metode Pembayaran**:
   - Pilih metode pembayaran yang akan digunakan (misalnya: *Cash*, *QRIS*, *Transfer BCA*, *Debit*, dll.).
4. **Pembuatan Antrean**:
...
* **Informasi Posisi Antrean Live**: Di bawah QR Code tiket, sistem akan menampilkan informasi posisi antrean secara langsung:
  - *"Anda berada di antrean ke-X (menunggu X orang di depan Anda)"*.
